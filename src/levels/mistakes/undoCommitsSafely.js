        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              "## Your Task",
              "",
              "The remote repository has already been cloned for you, and three commits have already been pushed to `main`.",
              "",
              "The history currently ends at `C4`:",
              "",
              ...
              "",
              "Use the commit graph and relative references from `HEAD` to choose the commit that added `bug.txt`.",
              "",
