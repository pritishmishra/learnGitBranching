        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              ...
              "",
              "`C1` is the shared starting commit. Your local `main`, your local `o/main`, and the remote `origin/main` all started there.",
              "",
              ...
              "4. `git commit -m \"<setup message>\"` created commit `C2`.",
              "5. A teammate added another commit `C3` to `main` as shown below.",
              "6. `touch api.txt`",
              "7. `git add api.txt`",
              "8. `git commit -m \"<setup message>\"` created commit `C3`.",
              "9. `git push origin main`",
              "10. You are on `feature-notifications`.",
              "",
              "### Your objectives",
              "",
