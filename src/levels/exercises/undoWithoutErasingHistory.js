...
exports.level = {
  ...
  "solutionCommand": "git revert HEAD~1;git push",
  "startTree": startTree,
  "initialGitConfig": {
    "user.name": "Student",
  ...
  "hint": {
    "en_US": "Use git revert HEAD~1, then push the new revert commit"
  },
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              ...
              "",
              "Two commits have been pushed to `main`.",
              "",
              "Commit `C1` added `experimental.txt`, and commit `C2` added `release-notes.txt`.",
              "",
              "You must remove `experimental.txt` while keeping `release-notes.txt`.",
              "",
              "### Your objectives",
              "",
              "1. Revert the second-most-recent commit (`C1`). This should create a new commit without removing any existing commits.",
              "2. Make sure `experimental.txt` is removed and `release-notes.txt` remains.",
              "3. Push the new commit to `origin/main`.",
              "",
