        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              ...
              "```",
              "",
              "In this example, the three versions of `shared.txt` are:",
              "",
              "```",
              "original version: Project Plan",
              "```",
              "```",
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              ...
              "```",
              "",
              "Git should report a conflict in `shared.txt`. Run `git diff` to see the conflict markers.",
              "",
