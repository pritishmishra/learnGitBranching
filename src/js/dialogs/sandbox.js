  ...
  'en_US': [{
    ...
    options: {
      markdowns: [
        ...
        'The terminal is where you type Git commands. The graph is a visual model of repository',
        'history; it is not a full file editor. Each circle is a saved project snapshot, called a',
        'commit. Labels such as `main` show where a line of history currently points.',
        '',
        'Some commands change files without changing the graph right away. Creating or staging a file',
        'affects the working directory or staging area, but the graph changes only after a commit is',
        'created.',
        '',
